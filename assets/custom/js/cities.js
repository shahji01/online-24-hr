...
function addMoreRow() {
    ...
    $('#addMoreSection').append('<div id="sectionAddMore_'+counter+'"><div class="lineHeight">&nbsp;</div>' +
        ...
        '<span><label>City</label><a href="#" onclick="removeAddMoreSection('+counter+')" class="btn btn-sm btn-danger" style="float: right;">X</a></span>' +
        '<span class="rflabelsteric"><strong>*</strong> </span>' +
        '<input type="text" name="city[]" id="city_'+counter+'" class="form-control requiredField" /></div></div></div>')
}
...
function viewCityListDetail() {
    $('#tableData').html('<div class="loader"></div>');
    $.ajax({
        url: baseUrl+'/hdc/viewCityListDetail',
        type: "GET",
        data:{m:m},
