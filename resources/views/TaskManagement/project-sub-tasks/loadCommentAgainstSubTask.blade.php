...
<div class="row">
    @foreach($getCommentDetail as $gcdRow)
        @php
            ...
            $attachments = DB::table('sub_task_comment_attachments')->where('sub_task_comment_id',$gcdRow->comment_id)->get();
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 alert alert-secondary">
                        <h4>Add Reply</h4>
                        <form id="addReplyAgainstCommentSubTask_{{$gcdRow->comment_id}}">
                            <div class="form-group">
                                <textarea class="form-control" name="reply_body_{{$gcdRow->comment_id}}" id="reply_body_{{$gcdRow->comment_id}}"></textarea>
                            </div>
                            <div class="form-group">
                                <input type="button" onclick="addReply('{{$gcdRow->comment_id}}')" class="btn btn-primary" value="Add Reply" />
                            </div>
                        </form>
                    </div>
                </div>
