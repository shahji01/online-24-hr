            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="card-title mb-0">Create Project Sub Task Form</h4>
                            </div>
                            <div class="col-sm-6 text-right">
                                <a class="btn btn-xs btn-primary" href="{{ url('/tms/project-sub-task') . '?m=' . $m }}">View List</a>
                            </div>
                        </div>
                        <hr>
                        {{ Form::open(array('url' => 'tms/project-sub-task/store')) }}
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select class="form-control" name="project_id" id="project_id" required onchange="loadTaskAgainstProjectId()">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <select class="form-control" required name="task_id" id="task_id">
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label class="sf-label">Sub Task Name:</label>
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <input type="text" name="sub_task_name" required id="sub_task_name" class="form-control requiredField" />
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label>Sub Task Type</label>
                                        <select name="sub_task_type" id="sub_task_type" required class="form-control requiredField">
