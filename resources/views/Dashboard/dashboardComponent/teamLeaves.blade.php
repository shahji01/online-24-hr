                ...
                @if(count($leave_application_request_list) != '0')
                    @foreach($leave_application_request_list as $value)
                        <tr>
                            ...
                            <td class="text-center">{{ $all_employees[$value->employee_id]->emp_id }}</td>
                            <td class="text-center">{{ $all_employees[$value->employee_id]->emp_name }}</td>
...
<div class="tab-pane fade in" id="teamLeaves"></div>