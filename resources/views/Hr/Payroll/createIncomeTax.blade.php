...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <!-- Start Page Content -->
        <!-- ============================================================== -->
        <?php echo Form::open(array('url' => 'had/addIncomeTaxDetail'));?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <label class="sf-label">Opening Balance:</label>
                                <input type="number" name="opening_balance" id="opening_balance" class="form-control requiredField">
                            </div>
