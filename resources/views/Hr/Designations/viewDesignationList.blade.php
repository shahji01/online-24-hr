...
@section('content')
    ...
    <a href="{{ url('/hr/createDesignationForm') . '?m=' . $m }}" class="btn btn-sm btn-success">
        Add Designation
    </a>
</div>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            viewDesignationListDetail();
        });
        function viewDesignationListDetail() {
            $('#tableData').html('<div class="loader"></div>');
            $.ajax({
                url: '{{ url('/') }}/hdc/viewDesignationListDetail',
                type: "GET",
                data:{m:m},
