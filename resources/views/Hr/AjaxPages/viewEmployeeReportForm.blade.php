    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-md-3 col-lg-3 col-xs-12">
                ...
                <button class="btn btn-sm btn-info btn_search" id="search" style="margin-top: 6px;"><i class="fas fa-search fa"></i> Search</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('#search').click(function() {
		...
		if ($("#show_all").is(":checked")) {
			var data = {show_all: show_all, m:m,gender:gender};
			}			
		else{
			var data = {department_id:department_id,sub_department_id:sub_department_id,emp_id:emp_id,m:m,gender:gender};
			}
		
        $('#report-area').html('<div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="loader"></div></div></div>');
        
            $.ajax({
                url: baseUrl+"/HrReports/viewEmployeeReport",
                type: 'GET',
                data: data, 
