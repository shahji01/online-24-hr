    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                ...
                <b><input type="radio" name="attendance_status" id="attendance_status" value="1">Present</b> &nbsp
                <b><input type="radio" name="attendance_status" id="attendance_status" value="2">Absent</b>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                <span style="color: green; display: none; font-size: 18px" id="success-message">Attendance Submitted</span>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12"></div>
        </div>
    </div>
