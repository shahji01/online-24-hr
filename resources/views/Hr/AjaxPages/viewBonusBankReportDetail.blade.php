            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                        <h3 style="text-decoration: underline;">Subject: Transfer Bonus</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h4>You are authorized to transfer the bonus for the year ended 30 June <?php echo $year ?> into the following accounts:
                        </h4>
                    </div>
                </div>
                <br>
                    ...
                    <table class="table table-responsive table-bordered table-condensed" id="regionWisePayrollReport">
                        ...
                        @foreach($bonus->get() as $value)
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{ number_format($value->total_net,0) }}</td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right" style="text-decoration: underline;text-decoration-style: double;" >
                                <b style="text-decoration-line: overline;"><?php echo number_format($bonus->sum('total_net'),0);?></b>
                            </td>
