                                    ...
                                    @foreach($employee->get() as $value)
                                        ...
                                        <tr class="remove_row_<?=$value->id?>">
                                            ...
                                            <td class="text-center">
                                                <button data-toggle="tooltip" data-placement="right" title="Delete" onclick="deleteEmployeeCnicCopy('<?= Input::get('m') ?>','<?=$value->id?>')" class="btn btn-sm btn-danger" type="button">
