                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="table-responsive" id="printList">
                                    <table class="table table-sm mb-0 table-bordered table-striped table-hover" id="exportList">
                                        <thead>
                                        <th class="text-center glyphicon glyphicon-menu-down">S.No</th>
...
@section('script')
    <script>
        $(document).ready(function() {
            viewDepartmentListDetail();
        });

        function viewDepartmentListDetail() {
            var m = '{{ $m }}';
            $('#tableData').html('<div class="loader"></div>');
            $.ajax({
                url: '{{ url('/') }}/hdc/viewDepartmentListDetail',
                type: "GET",
                data:{m:m},
