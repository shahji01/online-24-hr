...
@section('content')
    ...
    <button type="reset" id="reset" class="btn btn-sm btn-primary">Clear Form</button>
    <input type="button" class="btn btn-sm btn-primary" value="Add More" onclick="addMoreRow()" />
{{-- <a href="{{ url('/viewDepartmentList') }}" class="btn btn-sm btn-info">View Department List</a> --}}
<a href="{{ url('/hr/viewDepartmentList') . '?m=' . $m }}" class="btn btn-sm btn-info">View Department List</a>
