...
@section('content')
    <div class="page-wrapper">
        {{ Form::open(array('url' => 'had/addEmployeeTransferDetail')) }}
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-8">
                                <h4 class="card-title">Employee Transfer Form</h4>
                            </div>
                        </div>
                        <hr>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-top: 40px">
                                        <button type="button" class="btn btn-sm btn-primary btn_search" onclick="viewEmployeeTransferFormDetail()"><i id="load" class="fas fa-search fa"> Search</i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
    <script>
        ...
        function viewEmployeeTransferFormDetail() {
            ...
            var company_id = '{{ $m }}';
            var rights_url = 'hr/createEmployeeTransferForm';
            jqueryValidationCustom();
            if (validate == 0) {
                $('#addMoreSection').html('<div class="loader"></div>');
                $.ajax({
                    url: '{{ url('/') }}/hdc/viewEmployeeTransferFormDetail',
                    type: "GET",
                    data: {
