            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-8">
                                <h4 class="card-title">Employee Attendance Error Report</h4>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-right">
                                        <input type="button" class="btn btn-sm btn-primary" onclick="viewAttendanceError()" value="Show Attendance Progress" style="margin-top: 40px;" />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function viewAttendanceError(){
            ...
            if(validate == 0){
                ...
                $.ajax({
                    url: baseUrl+'/hdc/viewAttendanceError',
                    type: "GET",
                    data: {month_year:month_year,job_type:job_type,m:m,employee_id:employee_id,category_id:category_id,location_id:location_id,
                        department_id:department_id,from_date:from_date,to_date:to_date,project_id:project_id},
