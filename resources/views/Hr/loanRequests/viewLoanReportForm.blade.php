                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-top: 40px">
                                        <button type="button" class="btn btn-sm btn-primary btn_search" onclick="viewLoanReportDetail()"><i id="load" class="fas fa-search fa"> Search</i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
     ...
     <script>
        ...
        function viewLoanReportDetail(){
            ...
            var year = $("#year").val();
            var company_id = '{{ $m }}';
            var rights_url = 'hr/viewLoanReportForm';
