...
@section('content')
    ...
    <div class="page-wrapper">
        {{ Form::open(['url' => 'had/addEmployeeAllowanceDetail']) }}
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <select style="width: 100%;" name="allowance_type_id_search"
                                                id="allowance_type_id_search" class="form-control requiredField">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="sf-label amount_label">Amount:</label>
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <input type="text" name="allowance_amount_search" id="allowance_amount_search" class="form-control requiredField" />
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-top: 40px">
                                        <button type="button" class="btn btn-sm btn-primary btn_search"
                                                onclick="viewAllowanceFormDetail()"><i id="load" class="fas fa-search fa"> Search</i>
                                        </button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div id="importProducts___BV_modal_body_" class="modal-body">
                    <form action="{{ url('had/addEmployeeAllowanceDetailCsv') }}" method="post" enctype="multipart/form-data">
                        <div class="row">
...
@section('script')
    <script>
        ...
        var csvFileData = [
            ['10038', 'Arrears', '2000','Arrears arrive' , '2022-11-16'],
            ['10038', 'Mobile', '2000','Mobile Allowance' , '']
        ];
        ...
        function download_csv_file() {
            ...
            var csv = 'Employee id, Allowance type,Allowance Amount ,Remarks,Date (if you want to give specific allowance once)\n';
            ...
            hiddenElement.download = 'Allowance file example.csv';
            hiddenElement.click();
        }
