            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body" id="PrintEmployeeList">
                        <div class="row">
                            <div class="col-sm-8">
                                <h4 class="card-title">View Trainings List</h4>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center hidden-print">
                                                    ...
                                                    @if(in_array('delete',$operation_rights))
                                                        @if($y->status == 1)
                                                            <button class="delete-modal btn btn-sm btn-danger" onclick="deleteRowCompanyHRRecords('<?php echo $m ?>','<?php echo $y->id ?>','trainings')">
