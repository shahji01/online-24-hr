...
@section('content')
    ...
    <div class="page-wrapper">
        {{ Form::open(array('url' => 'had/addLeaveTypeDetail')) }}
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="text" name="leave_type_name[]" id="leave_type_name_1" class="form-control requiredField" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <a href="{{ url('/hr/viewLeaveTypeList') . '?m=' . $m }}" class="btn btn-sm btn-info">
