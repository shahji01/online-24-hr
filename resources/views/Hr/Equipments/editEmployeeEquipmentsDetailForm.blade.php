                                                ...
                                                @if($employee_eobi_copy->count() > 0)
                                                    <div id="eobi_div_hide">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                            ...
                                                            <a onclick="showMasterTableEditModel('hdc/viewEmployeeEobiCopy','{{ $employee->id.'|'. $emr_no }}','View Employee Insurance Copy','{{ $m }}')" class="btn btn-info btn-sm" style="color: white;cursor: pointer;">View</a>
                                                        </div>
                                                    </div>
