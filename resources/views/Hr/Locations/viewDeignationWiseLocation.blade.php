            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body" id="PrintEmployeeList">
                        <div class="row">
                            <div class="col-sm-8">
                                <h4 class="card-title">Designation Wise Locations List</h4>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
...
@section('script')
    <script>
        $(document).ready(function() {
            viewLocationsListDetail();
        });
    
        function viewLocationsListDetail() {
            $('#tableData').html('<div class="loader"></div>');
            $.ajax({
                url: baseUrl+'/hdc/viewDesignationWiseLocationsListDetail',
                type: "GET",
                data:{m:m},
