            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-8">
                                <h4 class="card-title">Leaves Encashment Form</h4>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-top: 40px">
                                <button type="button" class="btn btn-sm btn-primary btn_search" onclick="leavesEncashmentFormDetail()"><i id="load" class="fas fa-search fa"> Search</i>
                                </button>
                            </div>
                        </div>
                    </div>
...
@section('script')
    <script>
        ...
        $('#year').select2();
        function leavesEncashmentFormDetail(){
            var year = $('#year').val();
            ...
            if(validate == 0){
                ...
                $.ajax({
                    url: baseUrl+'/hdc/leavesEncashmentFormDetail',
                    type: "GET",
                    data: {
                        year: year,
